              ...
              >
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  <button
                    ...
                    className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-white/55 hover:text-white hover:border-white/30 transition"
                    aria-label="Delete"
                  >
