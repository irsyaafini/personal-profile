      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          {Object.entries(grouped).map(([cat, list]) => (
            <div key={cat} className="rounded-2xl border border-white/[0.06] bg-[#161616] overflow-hidden">
...
function SkillForm({ initial, onClose, onSaved, onError }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center px-4 py-8 overflow-y-auto">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-[#161616] border border-white/10 shadow-2xl">
