    ...
    <footer className="relative mt-14">
      ...
      <div className="relative overflow-hidden">
        <GlassSurface
          ...
          style={{ position: 'absolute', inset: 0, zIndex: 0, width: '100%', height: '100%', borderRadius: 0 }}
        />
        {/* Top border line */}
        ...
        <div className="relative z-10 container-xl py-10 sm:py-12">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <Link to="/" className="font-display text-base sm:text-lg font-semibold tracking-tight text-white hover:text-white/80 transition">
                portfolio
              </Link>
              ...
              {Object.entries(socials).map(([key, value]) => {
                ...
                return (
                  <a
                    ...
                    rel="noreferrer"
                    className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 bg-white/[0.03] backdrop-blur text-white/55 hover:text-white hover:border-white/25 hover:bg-white/[0.07] transition"
                    aria-label={key}
                  >
